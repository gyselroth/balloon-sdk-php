...
class BalloonAppNotificationsV2Api
{
    ...
    public function deleteNotification($notification)
    {
        ...
        try {
            try {
                $response = $this->deleteNotificationRequest($notification);
     ...
     */
    public function deleteNotificationRequest($notification)
    {
        $request = $this->deleteNotificationPrepareRequest($notification);
     ...
     */
    protected function deleteNotificationPrepareRequest($notification)
    {
    ...
    public function getMyNotifications($query = null, $attributes = null, $offset = null, $limit = null, $sort = null)
    {
        ...
        try {
            try {
                $response = $this->getMyNotificationsRequest($query, $attributes, $offset, $limit, $sort);
            } catch (RequestException $e) {
                throw new ApiException(
                    "[{$e->getCode()}] {$e->getMessage()}",
                    $e->getCode(),
     ...
     */
    public function getMyNotificationsRequest($query = null, $attributes = null, $offset = null, $limit = null, $sort = null)
    {
        $request = $this->getMyNotificationsPrepareRequest($query, $attributes, $offset, $limit, $sort);
        return $this->client->send($request);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMyNotificationsPrepareRequest($query = null, $attributes = null, $offset = null, $limit = null, $sort = null)
    {
    ...
    public function getNotification($notification)
    {
        ...
        try {
            try {
                $response = $this->getNotificationRequest($notification);
            } catch (RequestException $e) {
                throw new ApiException(
                    "[{$e->getCode()}] {$e->getMessage()}",
                    $e->getCode(),
     ...
     */
    public function getNotificationRequest($notification)
    {
        $request = $this->getNotificationPrepareRequest($notification);
        return $this->client->send($request);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getNotificationPrepareRequest($notification)
    {
        // verify the required parameter 'notification' is set
        if ($notification === null || (is_array($notification) && count($notification) === 0)) {
            throw new \InvalidArgumentException(
    ...
    public function postNotification($body = null)
    {
        ...
        try {
            try {
                $response = $this->postNotificationRequest($body);
            } catch (RequestException $e) {
                throw new ApiException(
                    "[{$e->getCode()}] {$e->getMessage()}",
                    $e->getCode(),
     ...
     * @return array of \Balloon\Sdk\Model\BalloonAppNotfificationNotification, HTTP status code, HTTP response headers (array of strings)
     */
    public function postNotificationRequest($body = null)
    {
        $request = $this->postNotificationPrepareRequest($body);
        return $this->client->send($request);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postNotificationPrepareRequest($body = null)
    {
    ...
    public function sendBroadcast($body = null)
    {
        ...
        try {
            try {
                $response = $this->sendBroadcastRequest($body);
            } catch (RequestException $e) {
                throw new ApiException(
                    "[{$e->getCode()}] {$e->getMessage()}",
                    $e->getCode(),
     ...
     * @return array of \Balloon\Sdk\Model\BalloonAppNotfificationNotification, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendBroadcastRequest($body = null)
    {
        $request = $this->sendBroadcastPrepareRequest($body);
        return $this->client->send($request);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendBroadcastPrepareRequest($body = null)
    {
    ...
    public function sendMail($body = null)
    {
        ...
        try {
            try {
                $response = $this->sendMailRequest($body);
            } catch (RequestException $e) {
                throw new ApiException(
                    "[{$e->getCode()}] {$e->getMessage()}",
                    $e->getCode(),
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendMailRequest($body = null)
    {
        $request = $this->sendMailPrepareRequest($body);
        return $this->client->send($request);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendMailPrepareRequest($body = null)
    {
    ...
    public function subscribeNode($node, $subscribe = null, $exclude_me = null, $recursive = null)
    {
        ...
        try {
            try {
                $response = $this->subscribeNodeRequest($node, $subscribe, $exclude_me, $recursive);
            } catch (RequestException $e) {
                throw new ApiException(
                    "[{$e->getCode()}] {$e->getMessage()}",
                    $e->getCode(),
     ...
     */
    public function subscribeNodeRequest($node, $subscribe = null, $exclude_me = null, $recursive = null)
    {
        $request = $this->subscribeNodePrepareRequest($node, $subscribe, $exclude_me, $recursive);
        return $this->client->send($request);
    }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function subscribeNodePrepareRequest($node, $subscribe = null, $exclude_me = null, $recursive = null)
    {

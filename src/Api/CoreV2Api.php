...
class CoreV2Api
{
     ...
     * Add new group
     *
     * @param \Balloon\Sdk\Model\CoreV2Group $data data (optional)
     *
     ...
     * Add new group
     *
     * @param \Balloon\Sdk\Model\CoreV2Group $data (optional)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * Add new user
     *
     * @param \Balloon\Sdk\Model\CoreV2User $data data (optional)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * Add new user
     *
     * @param \Balloon\Sdk\Model\CoreV2User $data (optional)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * @param \Balloon\Sdk\Model\CoreV2Collection $body       body (required)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     *
     * @param string                              $collection Parent collection (required)
     * @param \Balloon\Sdk\Model\CoreV2Collection $body       (required)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * @return \Balloon\Sdk\Model\CoreV2Collection
     */
    public function createRootCollection($body)
    {
        list($response) = $this->createRootCollectionWithHttpInfo($body);
     ...
     * @return array of \Balloon\Sdk\Model\CoreV2Collection, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRootCollectionWithHttpInfo($body)
    {
        $returnType = '\Balloon\Sdk\Model\CoreV2Collection';
        $request = $this->createRootCollectionRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRootCollectionAsync($body)
    {
        return $this->createRootCollectionAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRootCollectionAsyncWithHttpInfo($body)
    {
        $returnType = '\Balloon\Sdk\Model\CoreV2Collection';
        $request = $this->createRootCollectionRequest($body);
     ...
     * @throws \InvalidArgumentException
     *
     * @return \Balloon\Sdk\Model\CoreV2UserNodeAttributeSummary
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Balloon\Sdk\Model\CoreV2UserNodeAttributeSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function getNodeAttributeSummaryWithHttpInfo($user)
    {
        $returnType = '\Balloon\Sdk\Model\CoreV2UserNodeAttributeSummary';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Balloon\Sdk\Model\CoreV2UserNodeAttributeSummary',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     *
     * @param string                         $group Resource identifier (required)
     * @param \Balloon\Sdk\Model\CoreV2Group $body  Set attributes for group (required)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     *
     * @param string                        $user Resource identifier (required)
     * @param \Balloon\Sdk\Model\CoreV2User $body Set attributes for user (required)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     *
     * @param string                         $collection Collection identifier (required)
     * @param \Balloon\Sdk\Model\CoreV2Share $body       Create a new share from an existing collection (required)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     *
     * @param string                        $node Node identifier (required)
     * @param \Balloon\Sdk\Model\CoreV2Node $body Change attributes (required)
     *
     * @throws \Balloon\Sdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRootCollectionRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(

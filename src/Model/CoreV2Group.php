 ...
 */
class CoreV2Group implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'core.v2.Group';
     ...
     * Sets name.
     *
     * @param null|string $name group name
     *
     * @return $this
     */
     ...
     * Sets member.
     *
     * @param null|string[] $member array of user id's
     *
     * @return $this
     */

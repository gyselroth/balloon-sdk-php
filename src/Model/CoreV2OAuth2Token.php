...
class CoreV2OAuth2Token implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'core.v2.OAuth2Token';
     ...
     * Sets access_token.
     *
     * @param string $access_token resource access_token
     *
     * @return $this
     */
     ...
     * Sets expires_in.
     *
     * @param float $expires_in The number of seconds the issues acceess_token is valid for. This is usually 1hour.
     *
     * @return $this
     */
     ...
     * Sets token_type.
     *
     * @param string $token_type The type of token. This is usually a Bearer token.
     *
     * @return $this
     */
     ...
     * Sets refresh_token.
     *
     * @param string $refresh_token an optional refresh token to get new access_tokens via the refresh_token grant type
     *
     * @return $this
     */
